...
| County GIS portals | county-level | .shp | High | High | coverage may be incomplete for multi-county districts, maintenance frameworks vary by county | **Supplemental Source.** use to fill gaps or cross-check district boundaries when district level data is unavailable |
